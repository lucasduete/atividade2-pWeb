...
<html>
    ...
    <body>
        ...
        <form id="cadastrar" method="POST" action="/atividadePw/controller">
            ...
            <input type="text" required="true" placeholder="Status(Ativo ou Inativo)" id="ativo" name="ativo" onblur="verificaAtivo()">
            <br/>
        ...
        <form id="buscar" method="GET" action="/atividadePw/controller">
            <input type="text" required="true" name="nomeCliente" placeholder="Nome do Cliente">
            <br/>
            <input type="submit">
        </form>
